...
String name = "Hehe";
int number = 2;
List<int> mylist = [2, 3, 3, 4];
Map<String, dynamic> myMap = {"String": 2};
...
class _MyHomePageState extends State<MyHomePage> {
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      body: Stack(
        children: [
          //Image.asset('assets/images/ios.jpg', fit: BoxFit.cover, height: 500),
          SizedBox(height: 500, child: Center(child: Text("Hello"))),
          ListTile(
